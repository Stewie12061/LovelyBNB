...
import com.example.lovelybnb.Data.ReadWriteUserDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginBtn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SignupActivit.this, LoginActivity.class);
                ...
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(SignupActivit.this, pairs);
                            ...
                            referenceProfile.child(firebaseUser.getUid()).setValue(writeUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()){
                                        ...
                                        Intent intent = new Intent(SignupActivit.this, MainActivity.class);
